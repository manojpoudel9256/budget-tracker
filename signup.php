    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p><?php echo $lang['start_tracking']; ?></p>
            </div>
            <div class="auth-body">
                <?php if ($error): ?>
                ...
                <?php if ($success): ?>
                    <div class="alert alert-success alert-custom d-flex align-items-center" role="alert">
                        ...
                        <div class="text-success fw-semibold"><?php echo $success; ?></div>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" action="">
                    <div class="form-floating mb-3">
                        ...
                        <label for="username"><i
                                class="fas fa-user me-2 text-muted"></i><?php echo $lang['username']; ?></label>
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-auth">
                            <?php echo $lang['get_started']; ?> <i class="fas fa-rocket ms-2"></i>
                        </button>
                    </div>
                </form>
            </div>
            <div class="auth-footer">
                <p class="mb-0"><?php echo $lang['already_have_account']; ?> <a
                        href="login.php"><?php echo $lang['sign_in']; ?></a></p>
            </div>
        </div>
    </div>
</body>
